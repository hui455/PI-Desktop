...
export const ko = {
  ...
  chat: {
    ...
    permissionAsk: "매번 묻기",
    permissionNoReview: "검토 없음",
    reviewInherit: "기본 검토자 따르기",
...
sklm: {
    ...
    approvalReviewer: "승인 검토자",
    approvalReviewerDesc: "승인이 필요한 작업을 검토할 대상을 선택합니다. 완전 자동 모드에서는 검토를 건너뜁니다.",
    reviewByUser: "직접 승인",
    reviewByModel: "자동 검토",
    reviewModel: "검토 모델",
    reviewModelDesc: "전역 기본값이 직접 승인이라도 세션에서 자동 검토를 선택하면 적용됩니다. 채팅 모델을 따르거나 고정 모델을 선택할 수 있으며, 사용할 수 없으면 직접 승인합니다.",
    reviewFollowSession: "현재 채팅 따르기",
    reviewModelUnavailable: "선택한 모델(사용 불가)",
    reviewThinking: "검토 추론 수준",
    reviewThinkingDesc: "독립적인 검토 요청의 추론 수준입니다.",
    reviewCostCaution: "자동 검토는 필요한 작업 정보를 선택한 모델에 전송하며 추가 토큰을 사용합니다. 셸과 플러그인에는 OS 샌드박스가 없습니다.",
    reviewPolicyTitle: "검토 정책",
    reviewPolicyVersion: "내장 버전 {{version}}",
    reviewPolicyDefault: "기본값",
    reviewPolicyCustom: "사용자 지정",
    reviewPolicyDesc: "전체를 편집할 수 있는 유일한 검토 정책입니다. 변경 사항은 다음 검토부터 적용되며 대기 중인 검토는 취소됩니다.",
    reviewPolicyEditor: "정책 내용",
    reviewPolicyLength: "{{count}} / {{max}}자",
    reviewPolicyInvalid: "길이 제한 내에서 비어 있지 않은 정책을 입력하세요.",
    reviewPolicySave: "정책 저장",
    reviewPolicyRestore: "기본값 복원",
    reviewPolicyUnsaved: "저장되지 않은 변경 사항",
    reviewPolicySaveFailed: "검토 정책을 저장할 수 없습니다. 초안은 유지되므로 다시 시도하세요.",
    reviewSettingsSaveFailed: "검토 설정을 저장할 수 없습니다. 다시 시도하세요.",
    reviewPolicyBoundary: "Host 권한과 강제 거부는 항상 적용됩니다. 도구 없는 검토, 신뢰할 수 없는 입력 처리, 구조화된 출력은 고정된 프로토콜 보호 장치이며 숨겨진 두 번째 정책이 아닙니다.",
  ...
  permission: {
    grantsTitle: "세션 권한",
    reviewHistoryTitle: "최근 권한 검토",
    reviewHistoryLoading: "검토 기록 불러오는 중…",
    reviewHistoryError: "검토 기록을 불러올 수 없습니다. 메뉴를 다시 열어 주세요.",
    reviewHistoryEmpty: "검토 기록 없음",
    reviewUnknownTool: "도구",
    reviewModel: "검토 모델: {{model}}",
    reviewTokens: "검토 사용량: {{count}} 토큰",
    reviewUsageUnknown: "검토 사용량 알 수 없음",
    reviewDecision: { allow_once: "이번에만 승인", deny: "거부됨", needs_user: "사용자에게 전달" },
    grantsLoading: "권한 불러오는 중…",
    grantsError: "권한을 불러오거나 변경하지 못했습니다. 메뉴를 닫았다 다시 열어 재시도하세요.",
    grantsEmpty: "세션 권한 없음",
    grantActor: "에이전트: {{actor}}",
    revokeGrant: "권한 철회: {{scope}}",
    revoke: "철회",
    clearGrants: "세션 권한 모두 철회",
    reviewing: "작업 검토 중…",
    takeOver: "직접 검토",
    scope: "승인 범위: {{scope}}",
    title: "권한 필요",
