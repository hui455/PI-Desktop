...
"slashCommandSourceUnavailable": "Liste des commandes indisponible, rien n'a été envoyé. Réessayez.",
    ...
    "permissionNoReview": "Sans révision",
    "reviewInherit": "Utiliser le réviseur par défaut",
...
sklm: {
    ...
    "approvalReviewer": "Révision des autorisations",
    "approvalReviewerDesc": "Choisissez qui examine les actions nécessitant une autorisation. Le mode entièrement automatique ignore cette étape.",
    "reviewByUser": "Me demander",
    "reviewByModel": "Révision automatique",
    "reviewModel": "Modèle de révision",
    "reviewModelDesc": "Utilisé par toute session en examen automatique, même si le réglage global est manuel. Suivre le modèle de la discussion ou en choisir un fixe ; s'il est indisponible, demander une autorisation manuelle.",
    "reviewFollowSession": "Suivre la discussion",
    "reviewModelUnavailable": "Modèle choisi (indisponible)",
    "reviewThinking": "Raisonnement du réviseur",
    "reviewThinkingDesc": "Effort de raisonnement des révisions indépendantes.",
    "reviewCostCaution": "La révision automatique transmet le contexte nécessaire au modèle choisi et utilise des jetons supplémentaires. Shell et les plugins ne sont pas isolés par le système.",
    "reviewPolicyTitle": "Politique de révision",
    "reviewPolicyVersion": "Version intégrée {{version}}",
    "reviewPolicyDefault": "Par défaut",
    "reviewPolicyCustom": "Personnalisée",
    "reviewPolicyDesc": "Il s'agit de l'unique politique de révision modifiable dans son intégralité. Les changements s'appliquent à la prochaine révision et annulent les révisions en attente.",
    "reviewPolicyEditor": "Contenu de la politique",
    "reviewPolicyLength": "{{count}} / {{max}} caractères",
    "reviewPolicyInvalid": "Saisissez une politique non vide dans la limite autorisée.",
    "reviewPolicySave": "Enregistrer la politique",
    "reviewPolicyRestore": "Restaurer les valeurs par défaut",
    "reviewPolicyUnsaved": "Modifications non enregistrées",
    "reviewPolicySaveFailed": "Impossible d'enregistrer la politique. Votre brouillon est conservé ; réessayez.",
    "reviewSettingsSaveFailed": "Impossible d'enregistrer les paramètres de révision. Réessayez.",
    "reviewPolicyBoundary": "Les permissions et refus impératifs de l'hôte restent applicables. La révision sans outils, les entrées non fiables et la sortie structurée sont des garanties fixes du protocole, pas une deuxième politique cachée.",
  ...
  "permission": {
    "grantsTitle": "Autorisations de session",
    "reviewHistoryTitle": "Vérifications récentes des permissions",
    "reviewHistoryLoading": "Chargement des vérifications…",
    "reviewHistoryError": "Impossible de charger les vérifications. Rouvrez le menu.",
    "reviewHistoryEmpty": "Aucune vérification",
    "reviewUnknownTool": "Outil",
    "reviewModel": "Modèle de vérification : {{model}}",
    "reviewTokens": "Vérification : {{count}} jetons",
    "reviewUsageUnknown": "Usage de vérification inconnu",
    "reviewDecision": { "allow_once": "Approuvé une fois", "deny": "Refusé", "needs_user": "Transmis pour décision" },
    "grantsLoading": "Chargement des autorisations…",
    "grantsError": "Impossible de charger ou modifier les autorisations. Fermez puis rouvrez ce menu.",
    "grantsEmpty": "Aucune autorisation de session",
    "grantActor": "Agent : {{actor}}",
    "revokeGrant": "Révoquer l’autorisation : {{scope}}",
    "revoke": "Révoquer",
    "clearGrants": "Révoquer toutes les autorisations de session",
    "reviewing": "Examen de l'action…",
    "takeOver": "Examiner moi-même",
    "scope": "Portée de l'autorisation : {{scope}}",
