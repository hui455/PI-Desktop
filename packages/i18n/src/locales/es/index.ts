...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
    ...
    "permissionNoReview": "Sin revisión",
    "reviewInherit": "Usar revisor predeterminado",
...
sklm: {
    ...
    "approvalReviewerDesc": "Elige quién revisa las acciones que requieren aprobación. El modo totalmente automático omite la revisión.",
    "reviewByUser": "Preguntarme",
    "reviewByModel": "Revisión automática",
    "reviewModel": "Modelo revisor",
    "reviewModelDesc": "Se usa en cualquier sesión con revisión automática, aunque el valor global sea aprobación manual. Usa el modelo del chat o fija otro; si no está disponible, se solicita aprobación manual.",
    "reviewFollowSession": "Seguir el chat actual",
    "reviewModelUnavailable": "Modelo elegido (no disponible)",
    "reviewThinking": "Razonamiento del revisor",
    "reviewThinkingDesc": "Nivel de razonamiento de las revisiones independientes.",
    "reviewCostCaution": "La revisión automática envía al modelo el contexto necesario y consume tokens adicionales. Shell y los plugins no tienen aislamiento del sistema operativo.",
    "reviewPolicyTitle": "Política de revisión",
    "reviewPolicyVersion": "Versión integrada {{version}}",
    "reviewPolicyDefault": "Predeterminada",
    "reviewPolicyCustom": "Personalizada",
    "reviewPolicyDesc": "Esta es la única política de revisión editable y se muestra completa. Los cambios se aplican a la próxima revisión y cancelan las revisiones pendientes.",
    "reviewPolicyEditor": "Contenido de la política",
    "reviewPolicyLength": "{{count}} / {{max}} caracteres",
    "reviewPolicyInvalid": "Introduce una política no vacía dentro del límite.",
    "reviewPolicySave": "Guardar política",
    "reviewPolicyRestore": "Restaurar predeterminada",
    "reviewPolicyUnsaved": "Cambios sin guardar",
    "reviewPolicySaveFailed": "No se pudo guardar la política. El borrador sigue disponible; vuelve a intentarlo.",
    "reviewSettingsSaveFailed": "No se pudo guardar la configuración de revisión. Vuelve a intentarlo.",
    "reviewPolicyBoundary": "Los permisos y denegaciones obligatorias del Host siguen vigentes. La revisión sin herramientas, las entradas no fiables y la salida estructurada son garantías fijas del protocolo, no otra política oculta.",
  ...
  "permission": {
    "grantsTitle": "Permisos de la sesión",
    "reviewHistoryTitle": "Revisiones recientes de permisos",
    "reviewHistoryLoading": "Cargando revisiones…",
    "reviewHistoryError": "No se pudieron cargar las revisiones. Vuelve a abrir el menú.",
    "reviewHistoryEmpty": "Aún no hay revisiones",
    "reviewUnknownTool": "Herramienta",
    "reviewModel": "Modelo revisor: {{model}}",
    "reviewTokens": "Revisión: {{count}} tokens",
    "reviewUsageUnknown": "Uso de revisión desconocido",
    "reviewDecision": { "allow_once": "Aprobado una vez", "deny": "Denegado", "needs_user": "Enviado a ti" },
    "grantsLoading": "Cargando permisos…",
    "grantsError": "No se pudieron cargar o modificar los permisos. Cierra y vuelve a abrir el menú.",
    "grantsEmpty": "No hay permisos de sesión",
    "grantActor": "Agente: {{actor}}",
    "revokeGrant": "Revocar permiso: {{scope}}",
    "revoke": "Revocar",
    "clearGrants": "Revocar todos los permisos de la sesión",
    "reviewing": "Revisando la acción…",
    "takeOver": "Revisar personalmente",
    "scope": "Alcance del permiso: {{scope}}",
