...
export const tr = {
  ...
  chat: {
    ...
    permissionNoReview: "İnceleme yok",
    reviewInherit: "Varsayılan inceleyiciyi kullan",
...
sklm: {
    ...
    approvalReviewer: "İzin inceleyicisi",
    approvalReviewerDesc: "Onay gerektiren işlemleri kimin inceleyeceğini seçin. Tam otomatik mod incelemeyi atlar.",
    reviewByUser: "Bana sor",
    reviewByModel: "Otomatik inceleme",
    reviewModel: "İnceleme modeli",
    reviewModelDesc: "Genel varsayılan manuel onay olsa da Otomatik inceleme seçen tüm oturumlarda kullanılır. Sohbet modelini izleyin veya sabit bir model seçin; model yoksa onay size sorulur.",
    reviewFollowSession: "Geçerli sohbeti izle",
    reviewModelUnavailable: "Seçili model (kullanılamıyor)",
    reviewThinking: "İnceleme düşünme düzeyi",
    reviewThinkingDesc: "Bağımsız incelemeler için düşünme düzeyi.",
    reviewCostCaution: "Otomatik inceleme gerekli işlem bağlamını seçilen modele gönderir ve ek belirteç kullanır. Shell ve eklentiler işletim sistemi korumalı alanında değildir.",
    reviewPolicyTitle: "İnceleme politikası",
    reviewPolicyVersion: "Yerleşik sürüm {{version}}",
    reviewPolicyDefault: "Varsayılan",
    reviewPolicyCustom: "Özelleştirilmiş",
    reviewPolicyDesc: "Bu, tamamı düzenlenebilen tek inceleme politikasıdır. Değişiklikler sonraki incelemede geçerli olur ve bekleyen incelemeleri iptal eder.",
    reviewPolicyEditor: "Politika içeriği",
    reviewPolicyLength: "{{count}} / {{max}} karakter",
    reviewPolicyInvalid: "Sınır içinde, boş olmayan bir politika girin.",
    reviewPolicySave: "Politikayı kaydet",
    reviewPolicyRestore: "Varsayılana dön",
    reviewPolicyUnsaved: "Kaydedilmemiş değişiklikler",
    reviewPolicySaveFailed: "İnceleme politikası kaydedilemedi. Taslağınız korunuyor; yeniden deneyin.",
    reviewSettingsSaveFailed: "İnceleme ayarları kaydedilemedi. Yeniden deneyin.",
    reviewPolicyBoundary: "Host izinleri ve kesin retler her zaman geçerlidir. Araçsız inceleme, güvenilmeyen girdilerin işlenmesi ve yapılandırılmış çıktı sabit protokol önlemleridir; ikinci bir gizli politika değildir.",
  ...
  permission: {
    grantsTitle: "Oturum izinleri",
    reviewHistoryTitle: "Son izin incelemeleri",
    reviewHistoryLoading: "İncelemeler yükleniyor…",
    reviewHistoryError: "İncelemeler yüklenemedi. Menüyü yeniden açıp deneyin.",
    reviewHistoryEmpty: "Henüz inceleme yok",
    reviewUnknownTool: "Araç",
    reviewModel: "İnceleme modeli: {{model}}",
    reviewTokens: "İnceleme: {{count}} token",
    reviewUsageUnknown: "İnceleme kullanımı bilinmiyor",
    reviewDecision: { allow_once: "Bir kez onaylandı", deny: "Reddedildi", needs_user: "Size iletildi" },
    grantsLoading: "İzinler yükleniyor…",
    grantsError: "İzinler yüklenemedi veya güncellenemedi. Yeniden denemek için menüyü kapatıp açın.",
    grantsEmpty: "Oturum izni yok",
    grantActor: "Aracı: {{actor}}",
    revokeGrant: "İzni geri al: {{scope}}",
    revoke: "Geri al",
    clearGrants: "Tüm oturum izinlerini geri al",
    reviewing: "İşlem inceleniyor…",
    takeOver: "Kendim inceleyeceğim",
    scope: "İzin kapsamı: {{scope}}",
