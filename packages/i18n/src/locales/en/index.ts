export const en = {
  ...
  chat: {
    ...
    permissionNoReview: "No review",
    reviewInherit: "Use default reviewer",
...
sklm: {
    ...
    approvalReviewerDesc: "Choose who decides requests that still need approval. Full auto skips review.",
    reviewByUser: "Ask me",
    reviewByModel: "Auto review",
    reviewModel: "Review model",
    reviewModelDesc: "Used whenever any session selects Auto review, even if the global default is Ask me. Follow the chat model or choose a fixed model; unavailable fixed models ask you instead.",
    reviewFollowSession: "Follow current chat",
    reviewModelUnavailable: "Previously selected model (unavailable)",
    reviewThinking: "Review thinking",
    reviewThinkingDesc: "Reasoning effort for independent reviews.",
    reviewCostCaution: "Auto review sends necessary action context to the selected model and uses extra tokens. Shell and plugins are not OS-sandboxed.",
    reviewPolicyTitle: "Review policy",
    reviewPolicyVersion: "Built-in version {{version}}",
    reviewPolicyDefault: "Default",
    reviewPolicyCustom: "Customized",
    reviewPolicyDesc: "This is the complete editable review policy. Changes take effect on the next review and cancel pending reviews.",
    reviewPolicyEditor: "Policy instructions",
    reviewPolicyLength: "{{count}} / {{max}} characters",
    reviewPolicyInvalid: "Enter a non-empty policy within the limit.",
    reviewPolicySave: "Save policy",
    reviewPolicyRestore: "Restore default",
    reviewPolicyUnsaved: "Unsaved changes",
    reviewPolicySaveFailed: "Could not save the review policy. Your draft is still here; try again.",
    reviewSettingsSaveFailed: "Could not save review settings. Try again.",
    reviewPolicyBoundary: "Host permissions and hard denies always apply. No-tool review, untrusted-input handling, and structured output are fixed protocol safeguards, not a second hidden business policy.",
  ...
  permission: {
    ...
    reviewHistoryTitle: "Recent permission reviews",
    reviewHistoryLoading: "Loading reviews…",
    reviewHistoryError: "Could not load reviews. Reopen this menu to retry.",
    reviewHistoryEmpty: "No reviews yet",
    reviewUnknownTool: "Tool",
    reviewModel: "Reviewer model: {{model}}",
    reviewTokens: "Review: {{count}} tokens",
    reviewUsageUnknown: "Review usage unknown",
    reviewDecision: { allow_once: "Approved once", deny: "Denied", needs_user: "Sent to you" },
    grantsLoading: "Loading grants…",
    grantsError: "Could not load or update grants. Close and reopen this menu to retry.",
    grantsEmpty: "No session grants",
    grantActor: "Agent: {{actor}}",
    revokeGrant: "Revoke grant: {{scope}}",
    revoke: "Revoke",
    clearGrants: "Revoke all session grants",
    reviewing: "Reviewing this action…",
    takeOver: "Review myself",
    scope: "Authorization scope: {{scope}}",
