...
export const zhCN = {
  ...
  chat: {
    ...
    permissionAsk: "每次询问",
    permissionNoReview: "跳过审核",
    reviewInherit: "跟随默认审批人",
...
sklm: {
    ...
    approvalReviewer: "审批人",
    approvalReviewerDesc: "选择由谁处理仍需审批的操作。全自动模式会跳过审核。",
    reviewByUser: "由我审批",
    reviewByModel: "自动审核",
    reviewModel: "审核模型",
    reviewModelDesc: "任何会话选择自动审核时都会使用此设置，即使全局默认由我审批。可跟随对话模型或指定模型；指定模型不可用时转人工。",
    reviewFollowSession: "跟随当前对话",
    reviewModelUnavailable: "已选模型（不可用）",
    reviewThinking: "审核思考等级",
    reviewThinkingDesc: "独立审核请求的思考等级。",
    reviewCostCaution: "自动审核会向所选模型发送必要的操作上下文，并消耗额外用量。Shell 和插件尚无操作系统沙箱。",
    reviewPolicyTitle: "审核策略",
    reviewPolicyVersion: "内置版本 {{version}}",
    reviewPolicyDefault: "默认",
    reviewPolicyCustom: "已自定义",
    reviewPolicyDesc: "这里是完整且唯一可编辑的审核业务策略。修改后将用于下一次审核，并取消待处理的旧审核。",
    reviewPolicyEditor: "策略内容",
    reviewPolicyLength: "{{count}} / {{max}} 字符",
    reviewPolicyInvalid: "策略不能为空，且不能超过长度限制。",
    reviewPolicySave: "保存策略",
    reviewPolicyRestore: "恢复默认",
    reviewPolicyUnsaved: "有未保存的修改",
    reviewPolicySaveFailed: "无法保存审核策略，草稿已保留，请重试。",
    reviewSettingsSaveFailed: "无法保存审核设置，请重试。",
    reviewPolicyBoundary: "Host 权限与硬性拒绝始终生效。无工具审核、不可信输入处理和结构化输出是固定的协议保障，不是第二份隐藏的业务策略。",
  ...
  permission: {
    grantsTitle: "本会话授权",
    reviewHistoryTitle: "近期权限审核",
    reviewHistoryLoading: "正在加载审核记录…",
    reviewHistoryError: "无法加载审核记录，请重新打开菜单重试。",
    reviewHistoryEmpty: "暂无审核记录",
    reviewUnknownTool: "工具",
    reviewModel: "审核模型：{{model}}",
    reviewTokens: "审核消耗：{{count}} token",
    reviewUsageUnknown: "审核用量未知",
    reviewDecision: { allow_once: "仅本次批准", deny: "已拒绝", needs_user: "转人工审批" },
    grantsLoading: "正在加载授权…",
    grantsError: "加载或修改授权失败。关闭并重新打开此菜单可重试。",
    grantsEmpty: "暂无会话授权",
    grantActor: "代理：{{actor}}",
    revokeGrant: "撤销授权：{{scope}}",
    revoke: "撤销",
    clearGrants: "撤销本会话全部授权",
    reviewing: "正在审核此操作…",
    takeOver: "由我审批",
    scope: "授权范围：{{scope}}",
    title: "需要权限",
